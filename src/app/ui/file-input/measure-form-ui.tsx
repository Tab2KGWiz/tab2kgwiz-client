...
const MeasureFormUI: React.FC<Props> = (props): JSX.Element => {
  return (
    <div>
      <button
        className="block text-white bg-blue-700 hover:bg-blue-800 ml-5 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 
